...
{
	if (HINTERNET internet = InternetOpenA("The-Developer-Nate/rbxfpsunlocker-modded", INTERNET_OPEN_TYPE_PRECONFIG, NULL, NULL, NULL))
	{
...
bool CheckForUpdates()
{
	...
	{
		char buffer[256];
		sprintf_s(buffer, "A new version of Roblox FPS Unlocker Modded is available.\n\nCurrent Version: %s\nLatest Version: %s\n\nVisit download page?", RFU_VERSION, latest_version.c_str());
